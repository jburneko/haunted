export class DiceFormater {
  ...
  static diceToString(dice) {
    if (!Array.isArray(dice)) dice = new Array(dice);
  ...
  static highlightDice(dice) {
    ...
    return dice.map((die) => {
      ...
      if (die === highestDie) obj.color = DiceFormater.DIE_COLOR.BLACK;
      return obj;
    });
  }
  ...
  static highlightVictories(dice, victories) {
    return dice.map((die, index) => {
      const obj = { value: die, color: DiceFormater.DIE_COLOR.WHITE };
      if (index < victories) obj.color = DiceFormater.DIE_COLOR.BLACK;
      return obj;
    });
  }
}
